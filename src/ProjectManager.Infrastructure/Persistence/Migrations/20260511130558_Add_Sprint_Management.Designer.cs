...
namespace ProjectManager.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260511130558_Add_Sprint_Management")]
    partial class Add_Sprint_Management
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectManager.Domain.Entities.Invitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ProjectManager.Domain.Entities.RolePermission", b =>
                {
                    b.Property<Guid>("RoleId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ProjectManager.Domain.Entities.WorkItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<decimal>("CompletionPercentageValue")
                        .HasPrecision(5, 2)
            ...
            modelBuilder.Entity("ProjectManager.Domain.Entities.RolePermission", b =>
                {
                    b.HasOne("ProjectManager.Domain.Entities.Permission", "Permission")
            ...
            modelBuilder.Entity("ProjectManager.Domain.Entities.WorkItem", b =>
                {
                    ...
                    b.HasOne("ProjectManager.Domain.Entities.WorkItem", "ParentWorkItem")
                        .WithMany("Subtasks")
